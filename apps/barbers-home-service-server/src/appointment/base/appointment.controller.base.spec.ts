...
describe("Appointment", () => {
  ...
  test("POST /appointments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        appointmentTime: CREATE_RESULT.appointmentTime.toISOString(),
  ...
  test("GET /appointments", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          appointmentTime: FIND_MANY_RESULT[0].appointmentTime.toISOString(),
  ...
  test("GET /appointments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        appointmentTime: FIND_ONE_RESULT.appointmentTime.toISOString(),
